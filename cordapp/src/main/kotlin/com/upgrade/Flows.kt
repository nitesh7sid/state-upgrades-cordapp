...
class Initiator(val counterparty: Party) : FlowLogic<Unit>() {
    ...
    override fun call() {
        ...
        val txCommand = Command(Contract.Action(), state.participants.map { it.owningKey })
        val txBuilder = TransactionBuilder(notary).withItems(StateAndContract(state, Contract.id), txCommand)
